...
def process_text(text):
    words = []
    word_dic = {'დაეხმარეთ':'დაგეხმაროთ', 'ვთხოვო': 'მთხოვეთ', tuple(['მოგვაწოდოთ', 'მიაწოდოთ']): 'მომაწოდოთ', 'გეკითხებით': 'მეკითხებით', 'მოგერიდებათ': 'ნუ მოგერიდებათ', 'დაუსვათ': 'დამისვით', 'პითონი': 'პაითონი', 'შეგქმნა': 'შემქმნა', 'შევიმუშავე': 'შემიმუშავა', 'გამარჯობა იქ': 'გამარჯობა'}
